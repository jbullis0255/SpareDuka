...
const SellerProcessOrder = ({ match, history }) => {
...
//     dispatch(updateSellerOrder(id, formData));
//   };
                    ...
                    {orderItems &&
                      orderItems.map((item) => (
                        <div key={item.product} className="row my-5">
                          ...
                          <p>Sold By: <Link to="seller/name">{item.seller}</Link></p>
                        </div>
                      ))}
...
export default SellerProcessOrder;
